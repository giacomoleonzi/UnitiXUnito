...
const char *host = "185.114.108.111";

  //**********************************************************
  //************Send Event************************************
  //**********************************************************
void send_event(const char *key, String value, String mytime) {
  ...
  String url = "http://www.greento.it/workshop-IOT/live-server-data-receive.php?";
  url += key;
  url += "=";
  url += value;
  url += "&time1=";
